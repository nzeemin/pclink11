...
const TestDescriptor g_Tests[] =
{
    ...
    { "DIGER-ALEX_K",     "DIGER",    "-SYMBOLTABLE -MAP DIGER.OBJ DIGEX1.OBJ DIGEX2.OBJ DIGEX3.OBJ DIGEX4.OBJ DIGEX5.OBJ PASCAL.OBJ" },
    ...
    { "DYABIN-novay_kopiya_161", "F", "-SYMBOLTABLE -MAP -EXECUTE:F.SAV -M:100000 -Q:PSP=2000 -Q:PS100=100000 -Q:PS160=160000 TEKLIB.LIB FK.OBJ FP.OBJ DPSP.OBJ PMAG.OBJ TEKDAT.OBJ FKP.OBJ F100.OBJ FKL.OBJ FDKL.OBJ FD.OBJ FD1.OBJ FDM.OBJ FDD.OBJ FKFO.OBJ PSDISK.OBJ MAG.OBJ TEKCOD.OBJ F160.OBJ FPM.OBJ FPM1.OBJ FLT.OBJ TSTHLT.OBJ FPM2.OBJ FSM.OBJ FDP.OBJ TESTUK.OBJ FNK.OBJ" },
    ...
    { "HCOMP-OGERASIMOV", "HCOMP",    "-SYMBOLTABLE -MAP HCOMP.OBJ" },
    ...
    { "khandy21yo-hello-LDA", "HELLO", "-LDA -SYMBOLTABLE -MAP HELLO.OBJ PUTCON.OBJ" },
    { "KINGOM-PASCAL",    "KINGOM",   "-SYMBOLTABLE -MAP KINGOM.OBJ KINGM2.OBJ KINGM3.OBJ KINGM4.OBJ KINGM5.OBJ KINGM6.OBJ PASCAL.OBJ" },
    ...
    { "negsym-ufasoft",   "A",        "-SYMBOLTABLE -MAP A.OBJ B.OBJ" },
    { "NEON-DIAMON",      "DIAMON",   "-SYMBOLTABLE -MAP DIAMON.OBJ DIALAB.OBJ DIAGAM.OBJ DIAOUT.OBJ DIAABS.OBJ DIASPR.OBJ DIAMOI.OBJ DIAPAL.OBJ DIAFNT.OBJ DIASOU.OBJ" },
    ...
    { "STALK-PASCAL",     "STALKP",   "-SYMBOLTABLE -MAP -M:1000 STALKP.OBJ FRANDU.OBJ PASCAL.OBJ" },
    ...
    { "TEST-PASCAL-ALPHAMAP", "TEST", "-SYMBOLTABLE -MAP -ALPHABETIZE TEST.OBJ PASCAL.OBJ" },
