...
echo CLINE-UKNC
CD ..\CLINE-UKNC
rem %PCLINK11% CLINE.OBJ CENV.OBJ CWENV.OBJ CSPR.OBJ CKING.OBJ > CLINE-my.log
rem RENAME CLINE.SAV CLINE-my.SAV
rem RENAME CLINE.MAP CLINE-my.MAP
rem RENAME CLINE.STB CLINE-my.STB
rem
echo DATIME
CD ..\DATIME
...
echo DW-ANDREY
CD ..\DW-ANDREY
%PCLINK11% DW.OBJ /X > DW-my.log
RENAME DW.SAV DW-my.SAV
...
echo HD-DVKEmulator
CD ..\HD-DVKEmulator
%PCLINK11% HD.OBJ /X > HD-my.log
RENAME HD.SAV HD-my.SAV
