...
echo ADD32-PATRON
CD ADD32-PATRON
%PCLINK11% ADD32.OBJ > ADD32-my.log
...
CD ..\EDINST-V2-17-NYS
%PCLINK11% EDINST.OBJ VER.OBJ > EDINST-my.log
...
echo LD-FD6W
CD ..\LD-FD6W
%PCLINK11% /EXECUTE:LD.SYS LD.OBJ SYSLIB.OBJ /X > LD-my.log
...
echo LP-DISK09
CD ..\LP-DISK09
%PCLINK11% /EXECUTE:LP.SYS LP.OBJ /X > LP-my.log
...
echo NETTST-DISK09
CD ..\NETTST-DISK09
%PCLINK11% NETTST.OBJ > NETTST-my.log
...
echo RDMTUN-DSKMXC
CD ..\RDMTUN-DSKMXC
%PCLINK11% RDMTUN.OBJ SYSLIB.OBJ > RDMTUN-my.log
